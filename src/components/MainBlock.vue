<template>
  <div :style="{ backgroundImage: `url(${currentImage})` }" class="block-app">
    <div class="header-down" id="header">
      <div class="header-info">
        <div class="header-title">PHOTOGRAPHER & FILMMAKER</div>
        <div class="header-subtitle">Aperture Studios</div>
...
export default {
  ...
  data() {
    return {
      images: [
        ...
        require('@/assets/img/mount.png'),
        require('@/assets/img/leaves.png'),
  ...
  mounted() {
    ...
    this.intervalId = setInterval(this.changeBackground, 10000);
  },
  beforeUnmount() {
